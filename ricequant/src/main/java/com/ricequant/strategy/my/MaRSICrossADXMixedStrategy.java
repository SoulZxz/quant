...
public class MaRSICrossADXMixedStrategy implements IHStrategy {
	...
	public void eaWork(IHStatistics stat, IHInfoPacks info, IHTransactionFactory trans) {
		...
		double rsiSignal = generateRSICrossSignal(stat);
		if (rsiSignal != 0) {
...
//			}
	...
	public double generateRSICrossSignal(IHStatistics stat) {
